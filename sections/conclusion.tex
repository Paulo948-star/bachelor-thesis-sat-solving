...
lernen konnte. Besonders spannend fand ich die Arbeit an der Forschung von Vorhersagen und die anschließende
Auswertung der Daten.

\subsection{Technische Daten}

Die Arbeit wurde von meinem Windows 11 Heim PC erstellt und mit WSl, damit diesem konnte ich mich mit einer ssh verbindung 
am PC der Technischen Fakultät anmelden, dies war von großem Vorteil da ich breits im meinem 
Bachelorprojekt mehr RAM für meine brechnungen brauchte. Tmux erwies sich als nützlich um Programme über 
einen längeren Zeitraum laufen lassen zu können.
