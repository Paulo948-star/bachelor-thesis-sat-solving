...
Zu guter Letzt werde ich untersuchen ob sich die Laufzeiten verbessern wenn man die gleichen Benchmarks 
...
Somit hatte ich letztendlich 324 gemeinsame Benchmarks zum vergleichen.
...
Im Rahmen der Experimente habe ich untersucht, wie sich unterschiedliche Grade der Vorverarbeitung 
(Preprocessing) auf die Gesamtlösungszeit von SAT-Instanzen auswirken. Dabei habe ich vollständige 
Lösungszeit (Full Runtime) mit der kombinierten Zeit aus Vorverarbeitung (Preprocessing Time) und 
verbleibender Lösungszeit (Remaining Runtime) verglichen. Die Laufzeiten bekam ich als Dateien von 
meinem Tutor der die jeweiligen Benchmarks mit SATzilla verglichen hat.
